                ...
                <defs>
                    <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stopColor="#4c6ef5">
                            <animate attributeName="stop-color" values="#4c6ef5;#28a745;#4c6ef5" dur="2s" repeatCount="indefinite" />
                        </stop>
                        <stop offset="100%" stopColor="#28a745">
                            <animate attributeName="stop-color" values="#28a745;#4c6ef5;#28a745" dur="2s" repeatCount="indefinite" />
                        </stop>
                    </linearGradient>
                </defs>
